...
public sealed class ConsoleTarget : TargetWithLayoutHeaderAndFooter
{
	...
	/// <summary>
	/// Obsolete and replaced by <see cref="P:NLog.Targets.ConsoleTarget.StdErr" /> with NLog v5.
	...
	/// <summary>
	/// Gets or sets whether to force <see cref="M:System.Console.WriteLine" /> (slower) instead of the faster internal buffering.
	/// </summary>
	/// <remarks>Default: <see langword="false" /></remarks>
	/// <docgen category="Console Options" order="10" />
	...
	/// <summary>
	/// Gets or sets whether to activate internal buffering to allow batch writing, instead of using <see cref="M:System.Console.WriteLine" />
	/// </summary>
