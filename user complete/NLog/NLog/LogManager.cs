...
public static class LogManager
{
	...
	/// <summary>
	/// Occurs when logging <see cref="P:NLog.LogManager.Configuration" /> changes. Both when assigned to new config or config unloaded.
	/// </summary>
	/// <remarks>
	...
	/// Gets the specified named custom <see cref="T:NLog.Logger" /> using the parameter <paramref name="loggerType" /> for creating instance.
	/// If you haven't defined your own <see cref="T:NLog.Logger" /> class, then use the overload without the loggerType.
	/// </summary>
	/// <param name="name">Name of the logger.</param>
	...
	/// <summary>
	/// Obsolete and replaced by by <see cref="M:NLog.LogManager.SuspendLogging" /> with NLog v5.
	...
	/// <summary>
	/// Obsolete and replaced by disposing the scope returned from <see cref="M:NLog.LogManager.SuspendLogging" /> with NLog v5.
