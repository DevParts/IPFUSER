...
internal static class JsonTypeReflector
{
	...
	{
		internal static readonly ThreadSafeStore<Type, Func<object[]?, object>> Instance = new ThreadSafeStore<Type, Func<object[], object>>(GetCreator);
	}
	...
	public static JsonConverter? GetJsonConverter(object attributeProvider)
	{
		...
		if (cachedAttribute != null)
		{
			Func<object[], object> func = CreatorCache.Instance.Get(cachedAttribute.ConverterType);
			if (func != null)
			{
	...
	{
		return (JsonConverter)CreatorCache.Instance.Get(converterType)(args);
	}
	...
	{
		return (NamingStrategy)CreatorCache.Instance.Get(namingStrategyType)(args);
	}
	...
	[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
	private static Func<object[]?, object> GetCreator([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)] Type type)
	{
