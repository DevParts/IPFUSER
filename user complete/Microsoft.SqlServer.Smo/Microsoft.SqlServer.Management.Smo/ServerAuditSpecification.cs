...
public sealed class ServerAuditSpecification : AuditSpecification, ISfcSupportsDesignMode
{
	...
	{
		private static int[] versionCount = new int[10] { 0, 0, 0, 7, 7, 7, 7, 7, 7, 7 };
	...
	[SfcReference(typeof(Audit), "Server[@Name = '{0}']/Audit[@Name = '{1}']", new string[] { "Parent.ConnectionContext.TrueName", "AuditName" })]
	[CLSCompliant(false)]
	...
	public static string UrnSuffix => "ServerAuditSpecification";

	internal static string ParentType => "SERVER";
