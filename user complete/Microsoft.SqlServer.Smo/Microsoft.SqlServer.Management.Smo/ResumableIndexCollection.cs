...
public sealed class ResumableIndexCollection : SimpleObjectCollectionBase
{
	...
	public ResumableIndex this[int index] => GetObjectByIndex(index) as ResumableIndex;

	public ResumableIndex this[string name] => GetObjectByName(name) as ResumableIndex;
