...
public sealed class CryptographicProviderCollection : SimpleObjectCollectionBase
{
	...
	public CryptographicProvider this[int index] => GetObjectByIndex(index) as CryptographicProvider;

	public CryptographicProvider this[string name] => GetObjectByName(name) as CryptographicProvider;
