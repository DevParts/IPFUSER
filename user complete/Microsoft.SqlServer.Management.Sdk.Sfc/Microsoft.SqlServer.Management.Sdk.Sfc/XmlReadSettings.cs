...
{
	private static uint disambiguationVariable = 1u;
	...
	public XmlReadSettings(XmlRead xmlReader)
		: base(xmlReader)
	{
		if (base.Reader["autogenerate_disambiguation_variable"] == null || !string.IsNullOrEmpty(base.Alias))
		{
			return;
		}
		lock (disambiguationLock)
		{
			base.Alias = disambiguationVariable.ToString();
			xmlReader.Alias = base.Alias;
			disambiguationVariable++;
			if (disambiguationVariable == 0)
			{
				disambiguationVariable = 3u;
			}
		}
	}
}
