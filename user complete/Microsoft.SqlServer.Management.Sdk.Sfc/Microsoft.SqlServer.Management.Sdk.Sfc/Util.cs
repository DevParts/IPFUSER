...
public class Util
{
	...
	public static Assembly LoadAssembly(string assemblyName)
	{
		...
		try
		{
			...
			assembly = SmoManagementUtil.LoadAssembly(fullName);
		}
		catch (Exception ex)
		{
	...
	{
		object obj = assembly.CreateInstance(objectType, ignoreCase: false, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, null, CultureInfo.InvariantCulture, null);
		if (obj == null)
		{
